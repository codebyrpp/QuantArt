...
class StyleTransfer(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.quant_conv_real = torch.nn.Conv2d(
        ...
        if checkpoint_encoder is not None and ckpt_path is None:
            ...
            ckpt_enc = torch.load(checkpoint_encoder, map_location='cpu')[
                'state_dict']
        ...
        if checkpoint_decoder is not None and ckpt_path is None:
            ...
            ckpt_dec = torch.load(checkpoint_decoder, map_location='cpu')[
                'state_dict']
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        quant_x, quant_y, quant_ref, diff_x2y, indices_y, indices_ref = self.transfer(
            x1, x2)
