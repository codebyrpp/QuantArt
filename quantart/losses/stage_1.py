...
from quantart.losses.lpips import LPIPS
from quantart.components.discriminator import NLayerDiscriminator, weights_init
...
class Stage1Loss(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
        ...
        print(f"Stage1Loss running with {disc_loss} loss.")
